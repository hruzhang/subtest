...
##' @examples
##' 1+1 # pending
rand_gen=function(X,Z_a,pars_init1=c(0.8,0.15,2,1,2,1),pars_init0=c(0.8,0.15,2,2,1,0),weights=rep(1,length(Z_a)), n_repeat=1, Ca=NULL,Cd=NULL,n0=NULL,Yd=NULL, file=NULL,seed=NULL,...) {
